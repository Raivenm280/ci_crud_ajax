            ...
            <div class="modal-content">
                ...
                <form action="#" method="POST" enctype="multipart/form-data" id="add_post_form" novalidate>
                    <div class="modal-body p-5">
                        <div class="mb-3">
                            <label>Code</label>
                            <input type="text" name="Code" class="form-control" placeholder="Title" required>
                            <div class="invalid-feedback">Code name is required!</div>
                        </div>

                        <div class="mb-3">
                            <label>Campus Name</label>
                            <input type="text" name="campusName" class="form-control" placeholder="Category" required>
                            <div class="invalid-feedback">Campus Name is required!</div>
                        </div>

                        <div class="mb-3">
                            <label>location</label>
                            <input type="text" name="location" class="form-control" placeholder="Body" maxlength="3" required></input>
                ...
                <div class="col-lg-12">
                    <div class="table shadow">
                        <div class=" d-flex justify-content-between align-items-center mb-2">
                            ...
                            <h1 class="text-bold text-center">Campus</h1>
